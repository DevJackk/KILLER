--[[
   ...
   ███████     ██              ██      ███████     ██   █
                                                                ███
killer ✾ @V_P_E
تم تطوير وبرمجة السورس من قبل جاك والجوكر ✾ 
 @V_P_E
...
killer = Token:match("(%d+)")
redis:set(killer..":VERSION",1)
redis:set(killer..":SUDO_ID:",SUDO_USER)
redis:set(killer..":DataCenter:",'German')
redis:set(killer..":UserNameBot:",BOT_User)
redis:set(killer..":NameBot:",BOT_NAME)
redis:hset(killer..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3killer_INSTALL","Yes")
info = {}
...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس كيلر بنسبه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @SOURCEKILLER }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ KILLER source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer JACK : @V_P_E  }•\e[0m"

echo -e "\e[38;5;77m      killer ✾ @V_P_Ee[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل جاك والجوكر ✾ .e[0m"
...
killer = Token:match("(%d+)")
our_id = tonumber(killer)
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(killer..":UserNameBot:")
SUDO_ID = tonumber(redis:get(killer..":SUDO_ID:"))
SUDO_USER = redis:hgetall(killer..'username:'..SUDO_ID).username
version = redis:get(killer..":VERSION")
DataCenter = redis:get(killer..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..killer..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(killer..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(killer..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(killer..'group:add'..msg.chat_id_) then 
...
elseif msg.sender_user_id_ == 1282382975 then 
...
msg.Rank = 1
elseif redis:sismember(killer..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(killer..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(killer..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(killer..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(killer..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(killer..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(killer..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(killer..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(killer..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(killer..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(killer..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(killer..':NameBot:')..[[ .
• اختـصاصـي حمايـة الـمجموعات
• تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
• قنـاة سورس كيلر ⇐ @SOURCEKILLER
...
if msg.GroupActive and redis:get(killer..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(killer..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(killer..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(killer..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.killer then 
if msg.text and ScriptFile.ikiller then
for k, killer in pairs(ScriptFile.killer) do
local SearchText = msg.text:match(killer)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.ikiller(msg,{msg.text:match(killer)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",killer.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dkiller then
if ScriptFile.dkiller(msg) == false then
return false
end
...
if Plug.killer then 
if msg.text and Plug.ikiller then
for k, killer in pairs(Plug.killer) do
local SearchText = msg.text:match(killer)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(killer..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(killer..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.ikiller(msg,{msg.text:match(killer)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",killer.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dkiller then
Plug.dkiller(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source killer")
end 

end
else
print("The File Script.lua Not Runing in The Source killer")
...
function tdcli_update_callback(data)
	...
	redis:srem(killer..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/killer/main/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(killer..":SUDO_ID:")
redis:hset(killer..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(killer..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(killer..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(killer..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(killer..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(killer..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(killer..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(killer..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(killer..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(killer..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(killer..'group:add'..data.chat_.id_) then
	redis:set(killer..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(killer..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(killer..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(killer..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	killer..'group:name'..k,IDS.Title,
	killer..'num_msg_killer'..k,5,
	killer..'group:add'..k,true,
	killer..'lock_link'..k,true,
	killer..'lock_spam'..k,true,
	killer..'lock_webpage'..k,true,
	killer..'lock_markdown'..k,true,
	killer..'lock_flood'..k,true,
	killer..'lock_bots'..k,true,
	killer..'mute_forward'..k,true,
	killer..'mute_contact'..k,true,
	killer..'mute_document'..k,true,
	killer..'mute_inline'..k,true,
	killer..'lock_username'..k,true,
	killer..'replay'..k,true
	)
	redis:sadd(killer..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(killer..'username:'..ID,'username',user)
	redis:sadd(killer..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(killer..'username:'..ID,'username',user)
	redis:sadd(killer..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(killer..'username:'..ID,'username',user)
	redis:sadd(killer..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• ** تم رفع النسخه‏‏ الاحتياطيه\n• ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(killer..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(killer..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(killer..'username:'..data.user_.id_).username
	...
	redis:hset(killer..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
