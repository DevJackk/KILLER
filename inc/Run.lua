...
function tdcli_update_callback(data)
	...
	EditMsg(data.message_.chat_id_,data.message_.id_,'100% - |KILLER|\n\n• ** السورس الى اصدار \n• ** تم اعاده تشغيل السورس بنجاح')
	dofile("./inc/Run.lua")
