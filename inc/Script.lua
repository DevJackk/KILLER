...
local inline = {{{text="مبرمج السورس اضـغـط هـنـآ ",url="https://t.me/Da_rkk"}}}
send_key(msg.sender_user_id_,'   [المبرمج دارك](https://t.me/Da_rkk)' ,nil,inline,msg.id_)
return false
end
...
‌‌‏‌‌‏‌‏    ‌‌‏‌‌‏‌‌‌‌‏                                    
    🙋‍♂️╿~ اهلآ بـك عزيزي ~
📖╽~ في قائمة اوامر البوت ~
●ـ▬ـ▬ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ● 
🔐│~{م1} ~»  اوامـر الإداره .‌‏
🔐│~{م2} ~» اوامـر  اعدادات المجمّوعه .
🔐│~{م3} ~» اوامـر الحِمايـه . 
🔐│~{م4} ~» اوامـر الخِدمـه .
🔐│~{م5} ~» اوامـر التعَطيل و التفَعيل .
🔐│~{م6} ~» اوامـر الوضع للمجموعه .
🔐│~{م7} ~» اوامـر التسـليه .
🔐│~{م8} ~» اوامـر التسـليه الاخره .
🔐│~{اغاني} ~» لعرض الاغاني
🔐│~{الافلام} ~» لعرض قائمة الافلام
🔐│~{الالعاب} ~» لعرض قائمة الالعاب
🔐│~{الـمـطـور} ~» مـطـور الـبـوت
🔐│~{الـسـورس} ~» سـورس الـبـوت
🔐│~{الاعدادات} ~» لعرض اعدادات المجموعة
●ـ▬ـ▬ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ● 
[DEV : DARK](https://t.me/Da_rkk)
●ـ▬ـ▬ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ ـ●
...
if Black == 'welcome on' or Black == 'تفعيل الكيلر' then
if redis:get(killer..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الكيلر سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الكيلر')
redis:set(killer..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل كيلر' then
if redis:get(killer..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل كيلر سابقا')
redis:set(killer..'welc'..msg.chat_id_,'off')
redis:del(killer..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل كيلر')
end
end
...
local keyboard = {
{"دارك مالك السورس","المبرمج جاك"},
{"مصنع بوتات المبرمج"},
{"بوت دعم قنوات المبرمج"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل الكيلر","تعطيل كيلر"},
...
elseif Text== "دارك" or Text== "دارك " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس كيلر ❅](https://t.me/Da_rkk)")
elseif Text== "الجوكر" or Text== "الجوكر " then return  sendMsg(msg.chat_id_,msg.id_,"[حبيب الكل](https://t.me/A_j_o_k_e_r)")
