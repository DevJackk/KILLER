...
if MsgText[1]== "دارك مالك السورس" and msg.type == "pv" then
local inline = {{{text="مالك السورس اضـغـط هـنـآ ",url="https://t.me/Da_rkk"}}}
send_key(msg.sender_user_id_,'   [المالك دارك](https://t.me/Da_rkk)' ,nil,inline,msg.id_)
return false
end
