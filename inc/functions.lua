...
if redis:get(killer..'group:add'..msg.chat_id_) then  return '♡ **المجموعة تم تفعيلها مُسبقاً . ' end
...
if cmd == "dn_sudo" then
if not redis:sismember(killer..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'♡ **العضو » '..USERNAME..' \n♡ ** الايدي » (`'..UserID..'`)\n♡ **انه بالتأكيد ليس مطور \n') end
redis:srem(killer..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end
...
.."\n♡ التعديل «» "..(redis:get(killer..'lock_edit'..msg.chat_id_) or 'false')
.."\n♡ الروابط «» "..(redis:get(killer..'lock_link'..msg.chat_id_) or 'false')
.."\n♡ التاك «» "..(redis:get(killer..'lock_tag'..msg.chat_id_) or 'false')
.."\n♡ المعرفات «» "..(redis:get(killer..'lock_username'..msg.chat_id_) or 'false')
.."\n♡ التكرار «» "..(redis:get(killer..'lock_flood'..msg.chat_id_) or 'false')
.."\n♡ الكلايش «» "..(redis:get(killer..'lock_spam'..msg.chat_id_) or 'false')
.."\n♡ الويب «» "..(redis:get(killer..'lock_webpage'..msg.chat_id_) or 'false')
.."\n♡ الماركدوان «» "..(redis:get(killer..'lock_markdown'..msg.chat_id_) or 'false')
.."\n♡ بالطرد البوتات «» "..(redis:get(killer..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n♡ البوتات «» "..(redis:get(killer..'lock_bots'..msg.chat_id_) or 'false')
.."\n♡ عدد التكرار «» "..(redis:get(killer..'num_msg_killer'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡`اعدادات الوسائط :`\n"
.."\n*♡ *المتحركه «» "..(redis:get(killer..'mute_gif'..msg.chat_id_) or 'false')
.."\n♡ الدردشه «» "..(redis:get(killer..'mute_text'..msg.chat_id_) or 'false')
.."\n♡ الانلاين «» "..(redis:get(killer..'mute_inline'..msg.chat_id_) or 'false')
.."\n♡ الالعاب «» "..(redis:get(killer..'mute_game'..msg.chat_id_) or 'false')
.."\n♡ الصور «» "..(redis:get(killer..'mute_photo'..msg.chat_id_) or 'false')
.."\n♡ الفيديو «» "..(redis:get(killer..'mute_video'..msg.chat_id_) or 'false')
.."\n♡ البصمات «» "..(redis:get(killer..'mute_audio'..msg.chat_id_) or 'false')
.."\n♡ الصوت «» "..(redis:get(killer..'mute_voice'..msg.chat_id_) or 'false')
.."\n♡ الملصقات «» "..(redis:get(killer..'mute_sticker'..msg.chat_id_) or 'false')
.."\n♡ الجهات «» "..(redis:get(killer..'mute_contact'..msg.chat_id_) or 'false')
.."\n♡ التوجيه «» "..(redis:get(killer..'mute_forward'..msg.chat_id_) or 'false')
.."\n♡ الموقع «» "..(redis:get(killer..'mute_location'..msg.chat_id_) or 'false')
.."\n♡ الملفات «» "..(redis:get(killer..'mute_document'..msg.chat_id_) or 'false')
.."\n♡ الاشعارات «» "..(redis:get(killer..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n♡ الكيبورد «» "..(redis:get(killer..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*`اعدادات اخرى : `"
.."\n\n*♡*الترحيب «» "..welcomex
.."\n*♡*الردود «» "..replayx
...
.."\n*♡*الويب «» "..(redis:get(killer..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*♡*الماركدوان «» "..(redis:get(killer..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*♡*البوتات بالطرد «» "..(redis:get(killer..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*♡*البوتات «» "..(redis:get(killer..'lock_bots'..msg.chat_id_) or 'false')
.."\n*♡*عدد التكرار «» "..(redis:get(killer..'num_msg_killer'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*اعدادات التقـييد :\n"
.."\n*♡*التقييد بالتوجيه «» "..(redis:get(killer..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالصور «» "..(redis:get(killer..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالروابط «» "..(redis:get(killer..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالمتحركه «» "..(redis:get(killer..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد الفيديو «» "..(redis:get(killer..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
